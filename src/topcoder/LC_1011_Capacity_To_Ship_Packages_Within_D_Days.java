 ...
 * @author Chauncey
 * Runtime: 16 ms, faster than 31.59%
 */
public class LC_1011_Capacity_To_Ship_Packages_Within_D_Days
{
    public int shipWithinDays(int[] weights, int D) {

        if (weights==null || D<=0 || weights.length<D) return -1;
	...
	public static void main(String[] args)
	{
		...
		LC_1011_Capacity_To_Ship_Packages_Within_D_Days solution = new LC_1011_Capacity_To_Ship_Packages_Within_D_Days();
